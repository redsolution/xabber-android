...
public class ReferencesProvider extends ExtensionElementProvider<ReferenceElement> {
    ...
    private ReferenceElement parseMutable(XmlPullParser parser, int begin, int end) throws Exception {
        ...
        GroupchatMemberExtensionElement user = null;
        ...
        outerloop: while (true) {
            ...
            switch (eventType) {
                case XmlPullParser.START_TAG:
                    ...
                    } else if (GroupchatMemberExtensionElement.ELEMENT.equals(parser.getName())
                            && GroupchatMemberExtensionElement.NAMESPACE.equals(parser.getNamespace())) {
