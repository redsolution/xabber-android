...
public class AvatarXepTable extends AbstractTable {
    ...
    private static final String NAME = "xep_avatars";
    ...
    private static AvatarXepTable instance;

    public static AvatarXepTable getInstance() {
        if (instance == null) {
            instance = new AvatarXepTable(DatabaseManager.getInstance());
        }

        return instance;
    }

    private AvatarXepTable(DatabaseManager databaseManager) {
    ...
    public void migrate(SQLiteDatabase db, int toVersion) {
        ...
        switch (toVersion) {
            case 71:
                String sql = "CREATE TABLE xep_avatars (" + "user TEXT PRIMARY KEY,"
                        + "hash TEXT);";
                DatabaseManager.execSQL(db, sql);
                break;
            default:
