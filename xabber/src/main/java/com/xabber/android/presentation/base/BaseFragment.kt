...
abstract class BaseFragment(@LayoutRes contentLayoutId: Int) : Fragment(contentLayoutId) {
    ...
    protected fun <T : Fragment> clearBackstack(backstackTag: String? = APP_FM_BACKSTACK) {
        for (i: Int in 0..parentFragmentManager.backStackEntryCount)
            parentFragmentManager.popBackStack(backstackTag, FragmentManager.POP_BACK_STACK_INCLUSIVE)
    }
