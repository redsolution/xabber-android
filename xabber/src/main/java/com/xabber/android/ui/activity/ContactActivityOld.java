...
public class ContactActivityOld extends ManagedActivity implements
        OnContactChangedListener, OnAccountChangedListener, ContactVcardViewerFragment.Listener {

    private static final String LOG_TAG = ContactActivityOld.class.getSimpleName();
    ...
    public static Intent createIntent(Context context, AccountJid account, UserJid user) {
        return new EntityIntentBuilder(context, ContactActivityOld.class)
