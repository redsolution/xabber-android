...
class MamDataFormExtensionTest : TestCase() {
    ...
    fun test_toXml(){
        ...
        val dataForm2 = MamDataFormExtension(
                ids = listOf("firstId", "secondId", "anotherThirdId"),
                afterId = "afterId",
        )

        val reference3 = "<x xmlns='jabber:x:data' type='submit'><field var='FORM_TYPE' type='hidden'><value>urn:xmpp:mam:2</value></field><field var='with'><value>contact@server.domain</value></field><field var='start'><value>2019-02-12T19:33:20.000+00:00</value></field><field var='end'><value>2019-06-08T13:20:00.000+00:00</value></field></x>"
