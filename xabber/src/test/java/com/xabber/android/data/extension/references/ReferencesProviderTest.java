...
import com.xabber.xmpp.groups.GroupchatProvider;
...
public class ReferencesProviderTest {
    ...
    private String stringForward, stringMedia, stringMarkup1, stringMarkup2, stringMention,
            stringQuote, stringNull, stringUnknown, stringGroupchat, stringGroupPresence;
...
//    @Test
//    public void parse8() {
//        GroupchatExtensionElement element = parseGroupString(stringGroupchat);
//        assertNotNull(element);
...
//        assertEquals("http://xabber.org/images/d7072b2bc4652580911649870699787b18.jpeg",
//                user.getAvatarInfo().getUrl().toString());
//    }
//
//    @Test
//    public void parse9() {
